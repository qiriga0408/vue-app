...
<<<<<<< HEAD
	<div id="app">
		...
		<div id="webid">
			<div class="minbox" id="box" @mousedown.prevent="down()" @touchstart.prevent="down()" @mousemove.prevent="move()"
			 @touchmove.prevent="move()" @mouseup.prevent="end()" @touchend.prevent="end()">
